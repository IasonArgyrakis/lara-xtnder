...
class ExtendWebRoutesCommand extends Command
{
    protected $signature = 'xtnd:routes-web:add {name} {type} {modelName}';
    ...
    public function handle()
    {
        ...
        $route_contents = File::get("routes/web.php");
        if (!str_contains($route_contents, $route_text)) {
            File::append("routes/web.php", "\n" . $route_text);
        }else{
